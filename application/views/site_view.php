...
<?php $this->load->view('site_includes/header'); ?>
	...
	<div id='main' role='main'>
		...
		<section id="contact_form">
			...
			<p>For urgent questions or ordering, we are glad to help you. You can reach us by phone: +32 474 239 019 or by <a class="whitelink" href="mailto:stefanie@FlatTurtle.com">email</a>.</p>
			<?php
			if($form_submitted) {
